...
FuelTanks.Register("ACFE_Battery", {
	Name		= "[ACFE] Batteries Container",
	Description	= "Batteries, required for electric engines to work.",
})

do

	FuelTanks.RegisterItem("Battery_1x1x2", "ACFE_Battery", {
		Name		= "1x1x2 Battery",
	...
	FuelTanks.RegisterItem("Battery_1x1x4", "ACFE_Battery", {
		Name		= "1x1x4 Battery",
	...
	FuelTanks.RegisterItem("Battery_1x2x4", "ACFE_Battery", {
		Name		= "1x2x4 Battery",
	...
	FuelTanks.RegisterItem("Battery_1x4x4", "ACFE_Battery", {
		Name		= "1x4x4 Battery",
	...
	FuelTanks.RegisterItem("Battery_1x8x2", "ACFE_Battery", {
		Name		= "1x8x2 Battery",
	...
	FuelTanks.RegisterItem("Battery_1x8x4", "ACFE_Battery", {
		Name		= "1x8x4 Battery",
	...
	FuelTanks.RegisterItem("Battery_2x4x1", "ACFE_Battery", {
		Name		= "2x4x1 Battery",
		Description	= "",
	...
	FuelTanks.RegisterItem("Battery_2x4x2", "ACFE_Battery", {
		Name		= "2x4x2 Battery",
	...
	FuelTanks.RegisterItem("Battery_2x8x2", "ACFE_Battery", {
		Name		= "2x8x2 Battery",
		Description	= "",
	...
	FuelTanks.RegisterItem("Battery_2x8x4", "ACFE_Battery", {
		Name		= "2x8x4 Battery",
		Description	= "",
	...
	FuelTanks.RegisterItem("Battery_2x8x8", "ACFE_Battery", {
		Name		= "2x8x8 Battery",
		Description	= "",
