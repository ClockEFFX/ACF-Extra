...
Engines.Register( "ACFE_B8", {
	Name = "[ACFE] Flat 8 Engine",
})


do
	Engines.RegisterItem( "3.8-B8", "ACFE_B8", {
		Name		 = "3.8L Flat 8 Petrol",
	...
	Engines.RegisterItem( "6.0-B8", "ACFE_B8", {
		Name		 = "6.0L Flat 8 Petrol",
	...
	Engines.RegisterItem( "10.0-B8", "ACFE_B8", {
