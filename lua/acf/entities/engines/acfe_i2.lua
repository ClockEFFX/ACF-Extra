...
Engines.Register( "ACFE_I2", {
	Name = "[ACFE] Inline 2 Engine",
})


do
	Engines.RegisterItem( "2.6-I2", "ACFE_I2", {
		Name		 = "2.6L I2 Petrol",
	...
	Engines.RegisterItem( "0.7-I2", "ACFE_I2", {
		Name		 = "0.7L I2 Diesel",
	...
	Engines.RegisterItem( "1.8-I2", "ACFE_I2", {
		Name		 = "1.8L I2 Diesel",
	...
	Engines.RegisterItem( "7.3-I2", "ACFE_I2", {
		Name		 = "7.3L I2 Diesel",
