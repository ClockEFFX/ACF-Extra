...
Engines.Register( "ACFE_R3", {
	Name = "[ACFE] Radial 3 Engine",
})
...
do
	...
	Engines.RegisterItem( "1.2-R3", "ACFE_R3", {
		Name		 = "1.2L Radial 3 Petrol",
	...
	Engines.RegisterItem( "5.0-R3", "ACFE_R3", {
		Name		 = "5.0L Radial 3 Petrol",
	...
	Engines.RegisterItem( "11.0-R3", "ACFE_R3", {
		Name		 = "11.0L Radial 3 Petrol",
