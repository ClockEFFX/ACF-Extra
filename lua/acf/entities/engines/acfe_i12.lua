...
Engines.Register( "ACFE_I12", {
	Name = "[ACFE] Inline 12 Engine",
})


do
	Engines.RegisterItem( "4.4-I12", "ACFE_I12", {
		Name		 = "4.4L I12 Petrol",
		Description	 = "Incredibly stupid inline 12 made for fun.",
		Model		 = "models/engines/inline12s.mdl",
		Sound		 = "acf_extra/i12s.wav",
		Fuel		 = { Petrol = true },
		Type		 = "GenericPetrol",
		Mass		 = 340,
		Torque		 = 260,
	...
	Engines.RegisterItem( "13.0-I12", "ACFE_I12", {
		Name		 = "13.0L I12 Diesel",
		Description	 = "Truck duty inline 12, IF you can fit it.",
		Model		 = "models/engines/inline12m.mdl",
		Sound		 = "acf_extra/l6_dieselmedium4.wav",
		Fuel		 = { Diesel = true },
		Type		 = "GenericDiesel",
		Mass		 = 900,
		Torque		 = 1040,
	...
	Engines.RegisterItem( "40.0-I12", "ACFE_I12", {
		Name		 = "40.0L I12 Diesel",
		Description	 = "40 Liters?? Someone put a stop to this!",
		Model		 = "models/engines/inline12b.mdl",
		Sound		 = "acf_extra/l6_diesellarge2.wav",
		Fuel		 = { Diesel = true },
		Type		 = "GenericDiesel",
		Mass		 = 2400,
		Torque		 = 4200,
	...
	Engines.RegisterItem( "80.0-I12", "ACFE_I12", {
