...
do
	...
	Engines.RegisterItem( "3.2-X8", "ACFE_X8", {
		Name		 = "3.2L X8 Petrol",
		Description	 = "Small X8, surely the best way to make use of 8 cylinders.",
	...
	Engines.RegisterItem( "12.4-X8", "ACFE_X8", {
		Name		 = "12.4L X8 Petrol",
	...
	Engines.RegisterItem( "25.6-X8", "ACFE_X8", {
		Name		 = "25.6L X8 Petrol",
