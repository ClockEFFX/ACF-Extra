...
Engines.Register( "ACFE_X20", {
	Name = "[ACFE] X20 Engine",
})
...
do
	...
	Engines.RegisterItem( "8.0-X20", "ACFE_X20", {
		Name		 = "8.0L X20 Petrol",
	...
	Engines.RegisterItem( "31.0-X20", "ACFE_X20", {
		Name		 = "31.0L X20 Petrol",
	...
	Engines.RegisterItem( "74.0-X20", "ACFE_X20", {
		Name		 = "74.0L X20 Petrol",
