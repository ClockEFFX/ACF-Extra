...
Engines.Register( "ACFE_I8", {
	Name = "[ACFE] Inline 8 Engine",
})


do
	Engines.RegisterItem( "3.4-I8", "ACFE_I8", {
		Name		 = "3.4L I8 Petrol",
	...
	Engines.RegisterItem( "5.6-I8", "ACFE_I8", {
		Name		 = "5.6L I8 Petrol",
	...
	Engines.RegisterItem( "9.0-I8", "ACFE_I8", {
		Name		 = "9.0L I8 Petrol",
	...
	Engines.RegisterItem( "4.0-I8", "ACFE_I8", {
		Name		 = "4.0L I8 Diesel",
	...
	Engines.RegisterItem( "6.0-I8", "ACFE_I8", {
		Name		 = "6.0L I8 Diesel",
	...
	Engines.RegisterItem( "11.0-I8", "ACFE_I8", {
