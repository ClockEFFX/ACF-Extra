...
Engines.Register( "ACFE_X12", {
	Name = "[ACFE] X12 Engine",
})
...
do
	...
	Engines.RegisterItem( "4.8-X12", "ACFE_X12", {
		Name		 = "4.8L X12 Petrol",
	...
	Engines.RegisterItem( "18.6-X12", "ACFE_X12", {
		Name		 = "18.6L X12 Petrol",
	...
	Engines.RegisterItem( "42.9-X12", "ACFE_X12", {
		Name		 = "42.9L X12 Petrol",
