...
Engines.Register( "ACFE_X16", {
	Name = "[ACFE] X16 Engine",
})
...
do
	...
	Engines.RegisterItem( "6.4-X16", "ACFE_X16", {
		Name		 = "6.4L X16 Petrol",
	...
	Engines.RegisterItem( "24.8-X16", "ACFE_X16", {
		Name		 = "24.8L X16 Petrol",
	...
	Engines.RegisterItem( "57.2-X16", "ACFE_X16", {
		Name		 = "57.2L X16 Petrol",
